...
def get_underline(img_for_box_extraction_path):
    og_img = slicing.slice_image_get_remaining(img_for_box_extraction_path)
    ...
    lines = cv2.HoughLinesP(edges, 1, np.pi/180, 30,  minLineLength = height//2)
    ...
    utils.display_image("Lines", lines)
...
get_underline(img_for_box_extraction_path)
