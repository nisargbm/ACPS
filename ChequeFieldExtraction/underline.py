...
def get_underline(img_for_extraction_path, file_name, dir_path, img):
	...
	utils.store_img(dir_path, underline + "_" + str(idx) + "_" + img_for_extraction_path, amount_image, "handwritten2")
...
# 		print("contour")
	...
	# utils.display_image('captcha_result', final_img)
	utils.store_img(dir_path, img_for_extraction_path, final_img, "legal_amount")
...
if __name__ == "__main__":
	...
	import glob
	# onlyfiles = glob.glob(my_path + "*.tif")#Cheque 309159,309069
	# print(onlyfiles)
	# i=0
	...
	onlyfiles = glob.glob(store + "handwritten2/" + "*.tif")
	print(onlyfiles)
	i=0
	for filepath in onlyfiles:
		img = cv2.imread(filepath , 0)
